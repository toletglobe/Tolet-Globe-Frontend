...
const HiringPartners = () => {
  ...
  return (
    <div
      className="h-full w-full py-8 px-6 bg-black flex flex-col items-center justify-center relative -top-8 border border-white rounded-lg shadow-lg"
      style={{
        width: "1212px",
        height: "246px",
        marginLeft: "auto",
    ...
    >
      {" "}
      {/* Align component to the right */}
      <div className="max-w-[1310px] w-full text-center">
        <div
          className="bg-black z-20 relative inline-block"
          style={{
            width: "392px",
            height: "49px",
            borderRadius: "10px",
        ...
        <div className="flex justify-center items-center flex-wrap gap-10 mt-12">
          {" "}
          {/* Centered logos */}
          <img
            src={linkedinLogo}
            ...
            onClick={() =>
              handleLogoClick(
                "https://www.linkedin.com/company/to-let-globe/posts/?feedView=all"
              )
            }
