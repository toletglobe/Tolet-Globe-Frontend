...
const Listing = () => {
  ...
  // const handleAddProperties = () => {
  //   navigate('./property/addProperty.jsx');  // Adjust this path as needed
  // };
  function handleOpen() {
    SetIsOpen(!isOpen)
  }
  ...
  return (
          ...
          <div className="container mx-auto px-10">
            <div>
              ...
              <button
                ...
                className="bg-white h-14 w-60 flex items-center justify-center text-black px-4 rounded-2xl"
              >
                <div className="flex items-center justify-center w-3/4 gap-4 pl-2">
                  <p>Add Properties</p>
                </div>
    ...
    <div className="bg-black text-white min-h-screen p-6 flex items-center justify-center">
      <div className="bg-black p-8 rounded-lg shadow-lg max-w-5xl w-full">
        <h2 className="text-2xl mb-6 font-bold text-left">Add New Property</h2>
        <form className="grid grid-cols-2 gap-6">
          {/* User ID */}
          <div>
            <label className="block mb-1">User ID</label>
            <input type="text" className="w-full p-2 bg-white rounded text-black placeholder-gray-700" placeholder="User ID" />
          </div>

          {/* Owner Name */}
          <div>
            <label className="block mb-1">Owner Name</label>
            <input type="text" className="w-full p-2 bg-white rounded text-black placeholder-gray-700" placeholder="Owner Name" />
          </div>

          {/* Owner Contact Number */}
          <div>
            <label className="block mb-1">Owner's Contact Number</label>
            <input type="text" className="w-full p-2 bg-white rounded text-black placeholder-gray-700" placeholder="Owner's Contact Number" />
          </div>

          {/* Alternate Contact Number */}
          <div>
            <label className="block mb-1">Owner's Alternate Contact Number</label>
            <input type="text" className="w-full p-2 bg-white rounded text-black placeholder-gray-700" placeholder="Owner's Alternate Contact" />
          </div>

          {/* Locality */}
          <div>
            <label className="block mb-1">Locality</label>
            <input type="text" className="w-full p-2 bg-white rounded text-black placeholder-gray-700" placeholder="Enter Locality" />
          </div>

          {/* Address */}
          <div className="col-span-2">
            <label className="block mb-1">Address</label>
            <input type="text" className="w-full p-2 bg-white rounded text-black placeholder-gray-700" placeholder="Enter Address" />
          </div>

          {/* Space Type */}
          <div>
            <label className="block mb-1">Space Type</label>
            <select className="w-full p-2 bg-white rounded text-gray-700">
          ...
          <div>
            <label className="block mb-1">Current Residence of Owner</label>
            <select className="w-full p-2 bg-white rounded text-gray-700">
              <option>Select Current Residence</option>
          ...
          <div>
            ...
            <input type="text" className="w-full p-2 bg-white rounded text-black placeholder-gray-700" placeholder="Enter Rent" />
          </div>

          {/* Concession */}
          <div>
            <label className="block mb-1">Concession</label>
            <input type="text" className="w-full p-2 bg-white rounded text-black placeholder-gray-700" placeholder="Enter Concession" />
          </div>

          {/* Pets Allowed */}
          <div>
            <label className="block mb-1">Pets Allowed</label>
            <select className="w-full p-2 bg-white rounded text-gray-700">
          ...
          {/* Bachelor */}
          <div>
            <label className="block mb-1">Bachelor</label>
            <select className="w-full p-2 bg-white rounded text-gray-700">
              <option>Select Bachelor</option> 
          ...
          {/* Nearest Landmark */}
          <div>
            <label className="block mb-1">Nearest Landmark</label>
            <input type="text" className="w-full p-2 bg-white rounded text-black placeholder-gray-700" placeholder="Enter Landmark" />
          </div>

          {/* Type of Washroom */}
          <div>
            <label className="block mb-1">Type of Washroom</label>
            <select className="w-full p-2 bg-white rounded text-gray-700">
              <option>Select Type of Washroom</option>
          ...
          {/* Cooking Facility */}
          <div>
            <label className="block mb-1">Cooking Facility</label>
            <select className="w-full p-2 bg-white rounded text-gray-700">
              <option>Select Cooking Facility</option>
          ...
          <div className="col-span-2 flex justify-between">
            <button type="button" className="bg-white p-2 rounded text-black">Back</button>
            <button type="submit" className="bg-blue-600 p-2 rounded">Next</button>
          </div>
        </form>
      </div>
    </div>
