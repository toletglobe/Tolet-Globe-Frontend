...
export const ContactUs = () => {
  ...
  return (
    ...
    <div  className="my-10 mx-20 lg:h-[85vh] flex lg:justify-end "    
     style={{
      ...
      url(${location})`,
       ...
       <a href={googlemaps} >  
        <div className="text-star  h-[100%] lg:w-[860px] flex items-end ">
            <div className="text-white font-semibold lg:text-5xl text-left pb-5 mb-10 -ml-20 text-shadow-lg -stroke-2 -stroke-white lg:block hidden  ">
              CONTACT US
            </div>
          </div>        
      </a>
