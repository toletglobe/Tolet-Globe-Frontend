...
if(NewPassword === confirmPassword){
 try {
  ...
  const res = await(`${BASE_URL}auth/ChangePassword`, {
    currentPassword,
    NewPassword,
  },
  {
...
if(res.status ===200){
  ...
  toast.error("Password and currentPassword not matching");
}
  }
  ...
  return (
    <div className="min-h-screen flex justify-center items-center bg-black p-4">
      <div className="w-full max-w-2xl bg-black p-8 rounded-md shadow-lg">
        <div className="flex">
        <h2 className="text-3xl text-white font-semibold mb-6">Account Security</h2>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            <ul className="mt-3 space-y-1">
              ...
              >
                {passwordCriteria.uppercase ? "✔" : "✘"} Contains at least one uppercase letter
              </li>
              <li
                className={`text-sm ${
              ...
              >
                {passwordCriteria.lowercase ? "✔" : "✘"} Contains at least one lowercase letter
              </li>
              <li
                className={`text-sm ${
              ...
              >
                {passwordCriteria.number ? "✔" : "✘"} Contains at least one number
              </li>
            </ul>
          </div>
