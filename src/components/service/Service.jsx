  ...
  const services = [
    {
      ...
      title: "Paying Guest",
      bg: "bg-[#6CC1B6]",
      path: "/property-listing-lucknow?type=PayingGuest",
    ...
    },
    {
      ...
      title: "Flat",
      bg: "bg-[#CCB454]",
      path: "/property-listing-lucknow?type=Flat",
    ...
    },
    {
      ...
      title: "House",
      bg: "bg-[#6CC1B6]",
      path: "/property-listing-lucknow?type=House/Villa",
    ...
    },
    {
      ...
      title: "Shop",
      bg: "bg-[#CCB454]",
      path: "/property-listing-lucknow?type=Shop",
    ...
    },
    {
      ...
      title: "Office",
      bg: "bg-[#6CC1B6]",
      path: "/property-listing-lucknow?type=Office",
    ...
    },
    {
      ...
      title: "Warehouse",
      bg: "bg-[#CCB454]",
      path: "/property-listing-lucknow?type=Warehouse",
