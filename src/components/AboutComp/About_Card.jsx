...
export default function About_Card(props) {
  ...
  return (
   <>
     <div className = {`${containerClass} ${positionStyles} ${paddingStyles}  md:relative  md:w-[50.5%] md:mb-20 md:mt-0 md:ml-0 md:mr-0  sm:mx-6  mb-8   after:hidden  md:after:block  `}>
    ...
    <h1 className='text-center text-[#e59948] font-bold text-4xl sm:text-2xl'>{props.head}</h1>
