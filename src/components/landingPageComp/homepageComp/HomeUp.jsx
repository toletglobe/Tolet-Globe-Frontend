    ...
    <div className="relative w-full h-screen overflow-hidden">
      <div className=" flex justify-center items-center h-full">
        <div className="w-full relative">
          <h1
            className={`absolute -top-20 left-0 right-0 text-center text-white sm:text-4xl md:text-7xl text-3xl font-normal font-sans tracking-[0.3rem] transition-all duration-[1800ms] ease-in-out ${
              isScrolled
