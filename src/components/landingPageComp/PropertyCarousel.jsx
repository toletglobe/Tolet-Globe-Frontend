    ...
    <>
      <div className="bg-black text-white flex items-center justify-center flex-col p-5 mt-10 mb-10 w-full">
        <div className="flex items-center justify-center flex-col gap-3 w-full my-5 mb-8">
          Heading
          <h1 className="text-3xl md:text-4xl text-[#1b5f58] font-bold">
            Top Locations
          </h1>
          {/* Subheading */}
          <p className="w-full md:w-3/4 text-[12px] md:text-[14px] text-[#CCB454] text-center">
          ...
          {slides.map((slide, index) => (
            ...
            >
              <div className="flex flex-col md:flex-row">
                ...
                {/* Text on the right */}
                <div className="w-full md:w-1/2 pl-6 md:pl-8 flex flex-col justify-between items-start space-y-4 bg-gray-800 md:bg-transparent p-4">
                  <div>
                    <h2 className="text-[24px] md:text-[40px] font-normal text-left text-white">
                      Find the best To-Let <br />
                      in {slide.city}
                    </h2>
                    <p className="text-[#CCB454] text-left text-[12px] md:text-[14px] pt-2">
