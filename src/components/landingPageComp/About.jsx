...
const About = () => {
  return (
    <div className="bg-black w-full p-5 mt-[12%] mb-[5%] min-[768px]:min-w-[768px] max-[450px]:max-w-[450px]">
      ...
      <div className="block min-[768px]:hidden">
        <div className="flex flex-col lg:px-0">
          <div className="flex items-center justify-center lg:pt-[120px] pt-[70px] flex-wrap lg:flex-nowrap">
            ...
            <div md={6} className="pl-0 lg:pl-10 pb-10 pt-10">
              <h3 className="font-poppins text-4xl font-normal text-[#f6ce3c] pb-2 lg:text-left lg:pl-14">
                Who We Are
              </h3>
              <p className="font-poppins text-lg font-medium text-white leading-6 lg:text-left lg:pl-14">
                An Online Platform where property owners and tenants can directly
                contact each other with ZERO brokerage.
              </p>
            </div>
          ...
          <div className="flex items-center justify-center lg:pt-[120px] pt-[70px] lg:flex-nowrap flex-wrap">
            ...
            <div md={4} className="pl-0 lg:pl-10 pb-10 pt-10">
              <h3 className="font-poppins text-4xl font-normal text-[#f6ce3c] pb-2 lg:text-left lg:pl-14">
                Our Mission
              </h3>
              <p className="font-poppins text-lg font-medium text-white leading-6 lg:text-left lg:pl-14">
