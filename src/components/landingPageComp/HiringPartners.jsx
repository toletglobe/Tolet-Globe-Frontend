    ...
    <div className="margin">
      ...
      <div className="w-full px-3 py-6 md:py-8 bg-black flex flex-col items-center justify-center relative border border-white rounded-lg shadow-lg">
        {/* Absolutely positioned heading container:
            Its center aligns with the top border of the outer container */}
        <div
        ...
        >
            ...
            {images.concat(images).map((image, idx) => (
              <div
                ...
                className={`flex flex-col justify-center mx-9 my-5 ${
                  idx === 0 ? "ml-[26.61px]" : ""
                } ${idx === images.length - 1 ? "mr-[26.61px]" : ""}`}
              >
                <img
                  src={image.src}
          ...
          <div
            ref={scrollRef}
            className="flex md:hidden overflow-x-scroll cursor-grab whitespace-nowrap items-center"
