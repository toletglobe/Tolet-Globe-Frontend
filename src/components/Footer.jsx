        ...
        <div className="max-w-[1280px] mx-auto flex flex-col lg:flex-row lg:justify-between lg:items-start">
          ...
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left w-full lg:w-[250.67px] mb-8 lg:mb-0 ">
            ...
            <div className="w-[181.87px] mt-[20.44px] flex flex-row justify-between m-auto">
              <a href="https://www.linkedin.com/company/to-let-globe/posts/?feedView=all"><FaLinkedin className="w-[21.33px] h-[21.33px]" /></a>
              <a href="https://m.facebook.com/toletglobe/"><FaFacebookSquare className="w-[21.33px] h-[21.33px]" /></a>
              <Link
                  to="/twitter"
              ...
              <a href="https://www.instagram.com/toletglobe?igsh=bm1wdHkxbnF0MGhw"><RiInstagramFill className="w-[21.33px] h-[21.33px]" /></a>
            </div>
          </div>
