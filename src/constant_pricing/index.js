...
export const plans = [
  {
    ...
    price: "₹0",
    period: "/month",
    description: "Ideal for first-time or budget-conscious renters",
    ...
    features: [
      ...
      { icon: checkmark, text: "Search for roommates easily within our network" },
    ],
  },
  {
    id: 2,
    title: "Premium Plan (Pay After You Find)",
    price: "₹299",
    period: "/month",
    ...
    features: [
      ...
      { icon: filter, text: "Curated listings based on your preferences" },
