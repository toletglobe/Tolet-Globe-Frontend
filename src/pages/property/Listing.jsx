...
const filteredResults = [...filteredLocalities, ...filteredAreas];
  ...
  <div className="text-lg  rounded-full hover:cursor-pointer flex items-center gap-1">
    <p onClick={handleLocation} className="flex items-center gap-2">
      ...
      <img
                  ...
                  <div className="w-[1px] h-12 bg-black m-3 rounded">
  ...
  <input
    ...
    className="w-72 py-1 px-2 border-white bg-white outline-none"
  />
  {showSuggestions && filteredResults.length > 0 && (
      ...
      >
        ...
        <span className="text-sm text-gray-500 text-right">{result.type}</span>
              ...
              <div className="h-14 w-[80px] bg-white text-black flex items-start justify-between ">
                <div className="flex items-center h-full">
                  ...
                  <div><p className="text-lg">Filter</p></div>
                </div>
        ...
        <div className="m-20 -ml-[100px]" ref={filterRef}>
          <FiltersBox handleCloseFilter={handleCloseFilter}/>
              ...
              <div className="flex items-center justify-around bg-white" onClick={handleMode}>
