  ...
  return (
    <>
      <div className="flex flex-col  xl:pt-6 xl:pb-24  lg:px-6 space-y-4">
        ...
        {/* Property Cards */}
        <div className="w-full lg:max-w-8xl overflow-x-auto lg:px-20 lg:justify-items-center justify-items-start ">
  {/* Flex container for small screens and grid for large screens */}
  <div className="flex flex-nowrap overflow-x-auto space-x-4 lg:space-x-0 lg:grid lg:grid-cols-4 lg:gap-4 px-3">
    ...
    {compareProperty.length < 4 &&
      Array(4 - compareProperty.length)
        ...
        <div className="w-full lg:ml-10">
          ...
          {/* Comparison Table */}
          <div className="bg-white pt-8 lg:mr-16">
              ...
              {filteredProperties.map(({ key, label, icon }) => (
                <React.Fragment key={key}>
                  <tr className="lg:px-6 lg:py-4 bg-gray-200 flex">
                    <th className="lg:px-4 text-xl font-semibold text-left lg:w-[221px] w-[100px] h-[57px] flex items-center border-r border-black">
