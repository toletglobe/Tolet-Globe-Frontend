  ...
  return (
    <div className="pb-4 bg-white rounded-2xl">
      ...
      <div className="px-1 pt-4 pb-2">
        <div className="flex justify-between lg:w-[70%] items-start lg:mx-10">
          <div>
        ...
        <div className="w-full lg:w-[69%] h-64 lg:h-[550px]  absolute backdrop-blur-sm bg-black/40 flex justify-center items-center"></div>
          <iframe
            src={getMapSrc()}
            width="100%"
            height="100%"
